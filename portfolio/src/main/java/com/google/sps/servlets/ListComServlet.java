...
// Lists comments on page 
@WebServlet("/list-com")
public class ListComServlet extends HttpServlet {

  @Override
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
    Query query = new Query("comEntity").addSort("timestamp", SortDirection.DESCENDING);
    ...
    Gson gson = new Gson();
    String comToJSON = gson.toJson(comments);
    response.setContentType("application/json;");
    response.getWriter().println(comToJSON);
  }
}
